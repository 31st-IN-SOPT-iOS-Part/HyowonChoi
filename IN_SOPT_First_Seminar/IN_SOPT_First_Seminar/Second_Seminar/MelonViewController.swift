...
class MelonViewController: UIViewController {
        ...
        //버튼은 lazy var로 만드는게 좋음
        private lazy var nowBtn : UIButton = {
            let button = UIButton()
        ...
        private lazy var rewindButton = UIButton().then {
            $0.setBackgroundImage(UIImage(named: "icon_back"), for: .normal)
        }
        
        private lazy var playButton = UIButton().then {
            $0.setBackgroundImage(UIImage(named: "icon_Play"), for: .normal)
        }
        
        private lazy var fastForwardButton = UIButton().then {
            $0.setBackgroundImage(UIImage(named: "icon_next"), for: .normal)
        }
...
extension MelonViewController {
        ...
        private func layout() {
            ...
            [topView, nowBtn, musicView, trackLabel, djContainerView].forEach {
            ...
            let window = UIApplication.shared.keyWindow  //최상위 VC
            ...
            musicView.snp.makeConstraints {
                $0.top.equalTo(self.nowBtn.snp.bottom).offset(15)
